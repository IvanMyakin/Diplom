...
## План сдачи работ:
C 12.05.23 до 20.05.23 - планирование автоматизации тестирования, настройка окружения.
С 21.05.23 по 31.05.23  - написание и отладка автотестов, тестирование.
C 1.06.23 по 28.06.23  - подготовка отчетных документов.
